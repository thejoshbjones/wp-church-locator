...
if ( !class_exists( 'WPSL_Metaboxes' ) ) {
    ...
    class WPSL_Metaboxes {
        ...
        public function add_meta_boxes() {
            ...
            add_meta_box( 'wpsl-store-details', __( 'Church Details', 'wpsl' ), array( $this, 'create_meta_fields' ), 'wpsl_stores', 'normal', 'high' );
            add_meta_box( 'wpsl-map-preview', __( 'Church Map', 'wpsl' ), array( $this, 'map_preview' ), 'wpsl_stores', 'side' );
